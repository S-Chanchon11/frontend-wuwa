            ...
            <v-card-text >
              <div class="profile-info" >
                <h5 style="justify-content: center;font-weight: bold; color: white;">
                  ...
                  <input type="text" class="input" placeholder="Email" v-model = "this.email" disabled>
              <h5 style="justify-content: center;font-weight: bold; color: white;">
                <br>USERNAME
                <button class="edit" @click="edit">edit</button> 
              </h5> 
              <input type="text" class="input" placeholder="username" v-model = "this.username"disabled>
              </div>
            <!-- <br> -->
              <v-form >
